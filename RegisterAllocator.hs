...
def :: R.Statement -> Maybe R.Register
def (R.Load offset r)            = Just r
def (R.Null t r)                 = Just r
def (R.NewObj s1 r)              = Just r
def (R.NewIntArray r1 r)         = Just r
def (R.This r)                   = Just r
def (R.SInt v r)                 = Just r
def (R.SBoolean v r)             = Just r
def (R.Parameter position r)     = Just r
def (R.Call s1 r1 s2 is r)       = Just r
def (R.MemberGet s1 r1 s2 r)     = Just r
def (R.MemberAssg s1 r1 s2 r2 r) = Just r
def (R.VarAssg r1 r)             = Just r
def (R.IndexGet r1 r2 r)         = Just r
def (R.IndexAssg r1 r2 r3 r)     = Just r
def (R.Not r1 r)                 = Just r
def (R.Lt r1 r2 r)               = Just r
def (R.Le r1 r2 r)               = Just r
def (R.Eq r1 r2 r)               = Just r
def (R.Ne r1 r2 r)               = Just r
def (R.Gt r1 r2 r)               = Just r
def (R.Ge r1 r2 r)               = Just r
def (R.And r1 r2 r)              = Just r
def (R.Or r1 r2 r)               = Just r
def (R.Plus r1 r2 r)             = Just r
def (R.Minus r1 r2 r)            = Just r
def (R.Mul r1 r2 r)              = Just r
def (R.Div r1 r2 r)              = Just r
def (R.Mod r1 r2 r)              = Just r
def (R.Store r1 offset)          = Nothing
def (R.Branch r1)                = Nothing
def (R.NBranch r1)               = Nothing
def (R.Arg r1 p)                 = Nothing
def (R.Return r1)                = Nothing
def (R.Print r1)                 = Nothing
def (R.BeginMethod)              = Nothing
def (R.Label)                    = Nothing
def (R.Goto)                     = Nothing
